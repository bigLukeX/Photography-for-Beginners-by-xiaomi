  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        {
          label: '从这里开始',
          items: ['course-outline', 'guides/00-camera-app-quickstart'],
        },
        {
          label: '视觉基础与控制',
          items: [
        ...
        },
        {
          label: '样张、工具与安全',
          items: [
            'guides/visual-samples-and-references',
            'guides/pro-mode-tools',
            'guides/available-light-and-fill',
            'guides/street-portrait-ethics',
